import{o as Sa}from"./vendor-DWspd2SX.js";const ba=()=>{};var fs={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lc{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(hc(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function hc(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Yn="@firebase/app",gs="0.14.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xc(n){Ke(new Ne("platform-logger",e=>new lc(e),"PRIVATE")),Ke(new Ne("heartbeat",e=>new Kc(e),"PRIVATE")),ge(Yn,gs,n),ge(Yn,gs,"esm2020"),ge("fire-js","")}Xc("");var Zc="firebase",el="12.8.0";/**
 * @license
